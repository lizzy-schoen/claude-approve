...
# claude-sms-approve uninstaller
...
echo "=== claude-sms-approve uninstall ==="
echo ""
...
if [ -f "$SETTINGS_FILE" ] && command -v jq &>/dev/null; then
  ...
  echo "Manually remove the claude-sms-approve hooks from $SETTINGS_FILE"
fi

# Ask about config
echo ""
read -rp "Also delete Twilio config at $CONFIG_DIR? [y/N]: " DELETE_CONFIG
